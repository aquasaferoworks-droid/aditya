          ...
          <div className='container mx-auto flex flex-col items-center justify-start relative z-10'>
            <div className='flex flex-col items-center justify-center w-full h-[100dvh] relative'>
              ...
              >
                ...
                <div className='flex flex-col items-center text-center relative z-10 mt-12 transition-none'>
                  {date && (
                    <p
                      className='text-[10px] tracking-[0.5em] uppercase text-primary font-body font-bold'
