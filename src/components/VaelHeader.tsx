...
export function VaelHeader() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[300] bg-black border-b border-white/5">
      {/* Brand Bar - Reduced vertical spacing */}
      <nav className="px-6 md:px-16 flex items-center justify-between h-14 md:h-16 transition-all duration-300">
        ...
        <div className="flex-none text-center">
          <Link 
            href="/" 
            className="font-headline tracking-tight hover:opacity-90 transition-opacity block font-medium italic"
        ...
        <div className="flex-1 flex justify-end">
          <Button 
            className="rounded-lg bg-primary text-black hover:bg-white hover:text-black px-6 h-9 md:h-10 text-[13px] tracking-tight transition-all font-medium italic"
            asChild
          >
