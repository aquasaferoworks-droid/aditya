  ...
  return (
    <section id="hero" className="relative h-screen min-h-[700px] flex items-end overflow-hidden pb-20 px-8 md:px-16 bg-black">
      ...
      <div className="relative z-10 max-w-5xl animate-fade-in-up">
        ...
        <p className="max-w-md text-white/70 leading-relaxed text-sm md:text-base mb-10 font-body backdrop-blur-sm bg-black/5 p-4 border-l border-primary/30">
          Between the light and shadow. A singular language in world cinema — intimate yet epic, quiet yet thunderous.
        </p>
        ...
        <div className="flex flex-wrap gap-6">
          ...
          <Button variant="outline" className="rounded-none border-white/20 text-white hover:bg-white hover:text-black px-8 py-6 h-auto text-[11px] tracking-[0.2em] uppercase transition-all" asChild>
      ...
      <div className="absolute bottom-12 right-12 flex flex-col items-center gap-4 animate-scroll-pulse">
        <span className="text-[9px] tracking-[0.3em] uppercase text-white/40 writing-vertical-rl">Scroll</span>
